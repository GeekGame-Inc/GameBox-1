...
import com.john.superadapter.animation.AlphaInAnimation;
import com.john.superadapter.animation.BaseAnimation;
...
abstract class RecyclerSupportAdapter<T> extends RecyclerView.Adapter<SuperViewHolder>
	...
	public void addFooterView(View footer) {
		...
		Log.d( TAG, "count1 is " + count + " count2 is " + getItemCount() );
	}
	...
	public boolean removeFooterView() {
		if (hasFooterView()) {
			...
			Log.d( TAG, "count3 is " + footerPosition + " count4 is " + getItemCount() );
			return true;
		}
		return false;
	}
