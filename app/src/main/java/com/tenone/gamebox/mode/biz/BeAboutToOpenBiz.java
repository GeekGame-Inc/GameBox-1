 ...
 * File Name:BeAboutToOpenBiz.java 
 * Package Name:com.tenone.gamebox.mode.biz 
 * Date:2017-3-29����11:02:08 
...
import com.tenone.gamebox.mode.able.BeAboutToOpenAble;
...
public class BeAboutToOpenBiz implements BeAboutToOpenAble {
