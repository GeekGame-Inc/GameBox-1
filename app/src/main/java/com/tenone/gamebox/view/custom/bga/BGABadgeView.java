...
@SuppressLint("NewApi")
public class BGABadgeView extends AppCompatTextView {
    ...
    public static final int POSITION_CENTER_ = 6;
    ...
    public BGABadgeView(Context context, View target) {
        this( context, null, android.R.attr.textViewStyle, target, 0 );
    }

    public BGABadgeView(Context context, TabWidget target, int index) {
        this( context, null, android.R.attr.textViewStyle, target, index );
    }

    public BGABadgeView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, View target, int tabIndex) {
        ...
        setWidth( dipToPixels( 16 ) );
        setHeight( dipToPixels( 16 ) );
        setGravity( Gravity.CENTER );
        setTextColor( ContextCompat.getColor( context,R.color.gray_69 )  );
        setTextSize( 10, TypedValue.COMPLEX_UNIT_SP );
        isShown = false;
     ...
     * @param animate flag to apply the default fade-in animation.
     */
    public void showShape(boolean animate) {
        showShape( animate, fadeIn );
    }
    ...
    private void show(boolean animate, Animation anim) {
        if (getBackground() == null) {
            if (badgeBg == null) {
                badgeBg = getDefaultBackground( context );
            }
    ...
    private void showShape(boolean animate, Animation anim) {
        if (getBackground() == null) {
            if (shapeDrawable == null) {
                shapeDrawable = getDefaultBackground();
            }
    ...
    private Drawable getDefaultBackground(Context context) {
        ...
        if (Build.VERSION.SDK_INT > 21) {
            drawable = context.getDrawable( R.drawable.circle_white );
        } else {
    ...
    private void applyLayoutParams() {
        ...
        switch (badgePosition) {
            ...
            case POSITION_CENTER:
                ...
                break;
            case POSITION_CENTER_:
                lp.gravity = Gravity.CENTER;
                lp.setMargins( badgeMarginV, badgeMarginH, badgeMarginV,
                        badgeMarginH );
                break;
            default:
                break;
