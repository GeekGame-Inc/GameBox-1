...
public class MineFansFragment extends BaseLazyFragment implements HttpResultListener, SwipeRefreshLayout.OnRefreshListener, OnDriverItemClickListener, OnFansChangeListener {
    ...
    public void onRefresh() {
        page = 1;
        HttpManager.followList( HttpType.REFRESH, getActivity(), this, uid, page, 2 );
    }
    ...
    public void onFansChange() {
        ...
        Log.i( "MineFansFragment", "onFansChange" );
        page = 1;
        HttpManager.followList( HttpType.REFRESH, getActivity(), this, uid, page, 2 );
    }
