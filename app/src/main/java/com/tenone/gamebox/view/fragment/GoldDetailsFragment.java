...
public class GoldDetailsFragment extends Fragment implements OnRefreshListener,
	...
	public void requestHttp(int what) {
		HttpManager.platformCoinDetails(what, mContext, this, page, true);
	}
	...
	public void constructModels(ResultItem resultItem) {
		biz.constructModels(resultItem, this, true);
	}
