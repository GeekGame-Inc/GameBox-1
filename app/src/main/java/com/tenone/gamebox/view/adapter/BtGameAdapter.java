...
public class BtGameAdapter extends BaseAdapter {
	...
	public BtGameAdapter(List<GameModel> models, Context context, int type) {
		this.models = models;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate( R.layout.item_new_game_list, parent, false );
	...
	private class GameAdapterViewHolder {
		...
		private TextView nameTv, sizeTv, disTv, todayTv, welfareTv, timeTv, typeTv;
		...
		public GameAdapterViewHolder(View v) {
			...
			typeTv = v.findViewById( R.id.id_new_game_list_type );
		}
	}
}
