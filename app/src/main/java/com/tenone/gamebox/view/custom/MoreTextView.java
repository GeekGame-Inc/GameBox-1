...
public class MoreTextView extends LinearLayout {
    ...
    protected void initWithAttrs(Context context, AttributeSet attrs) {
        ...
        int textColor = a.getColor( R.styleable.MoreTextStyle_textColor_MoreTextStyle,
                defaultTextColor );
        textSize = a.getDimensionPixelSize( R.styleable.MoreTextStyle_textSize_MoreTextStyle,
                defaultTextSize );
        maxLine = a.getInt( R.styleable.MoreTextStyle_maxLine_MoreTextStyle, defaultLine );
        text = a.getString( R.styleable.MoreTextStyle_text_MoreTextStyle );
    ...
    protected void initalize() {
        ...
        addView( contentView, LayoutParams.MATCH_PARENT,
                LayoutParams.WRAP_CONTENT );

        int padding = dip2px( getContext(), 5 );
        LinearLayout layout = new LinearLayout( getContext() );
        layout.setVerticalGravity( HORIZONTAL );
        layout.setGravity( Gravity.CENTER );

        stateTextView = new TextView( getContext() );
        stateTextView.setText( getResources().getString( R.string.expand ) );
        stateTextView.setPadding( padding, padding, padding, padding );
        stateTextView.setTextColor( getResources().getColor( R.color.blue_40 ) );
        LayoutParams layoutParams = new LayoutParams(
                LayoutParams.WRAP_CONTENT,
                LayoutParams.WRAP_CONTENT );
        layout.addView( stateTextView, layoutParams );

        expandView = new ImageView( getContext() );
        expandView.setPadding( padding, padding, padding, padding );
        expandView.setImageResource( R.drawable.ic_expand_more );

        LayoutParams llp = new LayoutParams(
                LayoutParams.WRAP_CONTENT,
                LayoutParams.WRAP_CONTENT );
        layout.addView( expandView, llp );
        ...
        setOnClickListener( new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isExpand) {
                    ...
                    stateTextView.setText( getResources().getString( R.string.coll ) );
                } else {
