...
package com.tenone.gamebox.view.custom.refresh;
...
public class WaveSwipeRefreshLayout extends ViewGroup implements
	...
	/**
	 * {@link WaveSwipeRefreshLayout#mCircleView} ��������Ȥ���Duration
	 */
	...
	/**
	 * {@link WaveSwipeRefreshLayout#mListener} ��֪ͨ���뤫�ɤ�����Flag
	 */
	 ...
	 * Constructor {@inheritDoc}
	 */
	@SuppressLint("InflateParams") public WaveSwipeRefreshLayout(Context context, AttributeSet attrs,
			int defStyleAttr) {
	...
	/**
	 * @param refreshing
	 *            {@link WaveSwipeRefreshLayout#mState} �Υ��å�
	 */
