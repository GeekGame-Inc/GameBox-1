...
import com.tenone.gamebox.view.CustomBadgeAnimator;
...
public class CustomQBadgeView extends View implements Badge {
    ...
    protected CustomBadgeAnimator mAnimator;
    ...
    private CustomQBadgeView(Context context, AttributeSet attrs) {
        this( context, attrs, 0 );
    }

    private CustomQBadgeView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void animateHide(PointF center) {
        ...
        if (mAnimator == null || !mAnimator.isRunning()) {
            screenFromWindow( true );
            mAnimator = new CustomBadgeAnimator( createBadgeBitmap(), center, this );
            mAnimator.start();
            setBadgeNumber( 0 );
        }
    }
