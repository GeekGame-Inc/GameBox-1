...
public class SystemBarTintManager {
	...
	public static SystemBarTintManager instance;

	public static final int MNAVBARAVAILABLEINDEX =1;
	public static final int MSTATUSBARAVAILABLEINDEX=0;


	public static SystemBarTintManager getInstance(Activity activity) {
		if (instance == null) {
			instance = new SystemBarTintManager(activity);
		}
		return instance;
	}
	...
	public SystemBarTintManager(Activity activity) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
			...
			try {
				mStatusBarAvailable = a.getBoolean(MSTATUSBARAVAILABLEINDEX, false);
				mNavBarAvailable = a.getBoolean(MNAVBARAVAILABLEINDEX, false);
			} finally {
				a.recycle();
			}
