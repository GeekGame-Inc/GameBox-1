...
import com.tenone.gamebox.view.adapter.BGAPhotoPickerAdapter;
import com.tenone.gamebox.view.custom.popupwindow.BGAPhotoFolderPw;
import com.tenone.gamebox.view.utils.BGAAsyncTask;
import com.tenone.gamebox.view.utils.BGAImageCaptureManager;
import com.tenone.gamebox.view.utils.BGALoadPhotoTask;
import com.tenone.gamebox.view.utils.BGAPhotoPickerUtil;
import com.tenone.gamebox.view.utils.BGASpaceItemDecoration;
...
public class BGAPhotoPickerActivity extends BGAPPToolbarActivity implements BGAOnItemChildClickListener,
        BGAAsyncTask.Callback<ArrayList<BGAImageFolderModel>> {
    ...
    private static final String IS_GIF = "isGif";
    ...
    private static int mMaxChooseCount = 1;
    ...
    public static Intent newIntent(Context context, File imageDir, int maxChooseCount, ArrayList<String> selectedImages, boolean isGif) {
        Intent intent = new Intent( context, BGAPhotoPickerActivity.class );
        intent.putExtra( EXTRA_IMAGE_DIR, imageDir );
        intent.putExtra( EXTRA_MAX_CHOOSE_COUNT, maxChooseCount );
        intent.putStringArrayListExtra( EXTRA_SELECTED_IMAGES, selectedImages );
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        if (!EasyPermissions.hasPermissions( this, perms )) {
            EasyPermissions.requestPermissions( this, getString( R.string.phone_permissions),
                    1000, perms );
        }
    }
    ...
    protected void processLogic(Bundle savedInstanceState) {
        ...
        GridLayoutManager layoutManager = new GridLayoutManager( this,
                BGASpaceItemDecoration.SPAN_COUNT, LinearLayoutManager.VERTICAL, false );
    ...
    protected void onStart() {
        super.onStart();
        showLoadingDialog();
        mLoadPhotoTask = new BGALoadPhotoTask( this, this, mTakePhotoEnabled );
        if (getIntent().hasExtra( IS_GIF )) {
            mLoadPhotoTask.setGif( getIntent().getBooleanExtra( IS_GIF, false ) );
        }
        mLoadPhotoTask.perform();
    }
    ...
    public void onClick(View v) {
        if ((v.getId() == R.id.tv_photo_picker_title
                || v.getId() == R.id.iv_photo_picker_arrow)
                && mImageFolderModels != null && mImageFolderModels.size() > 0
                && System.currentTimeMillis() - mLastShowPhotoFolderTime > BGAPhotoFolderPw.ANIM_DURATION) {
            showPhotoFolderPw();
    ...
    private void showPhotoFolderPw() {
        ...
        mPhotoFolderPw.showAsDropDown( mTitleTv );
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_CODE_TAKE_PHOTO) {
                ...
                startActivityForResult( BGAPhotoPickerPreviewActivity.newIntent( this,
                        1, photos, photos, 0, true ), REQUEST_CODE_PREVIEW );
    ...
    private void changeToPreview(int position) {
        ...
        /*startActivityForResult( BGAPhotoPickerPreviewActivity.newIntent( this,
                mMaxChooseCount, mPicAdapter.getSelectedImages(), (ArrayList<String>) mPicAdapter.getData()
                , currentPosition, false ), REQUEST_CODE_PREVIEW );*/
    }
