package com.tenone.gamebox.view.custom.loadingindicator;
...
import com.tenone.gamebox.view.custom.loadingindicator.indicators.BallPulseIndicator;

/**
 * ���ؿ�loading.... ClassName: AVLoadingIndicatorView <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason: TODO ADD REASON(��ѡ). <br/>
 * date: 2017-3-8 ����10:08:29 <br/>
 *
 * @author John Lie
 * @since JDK 1.6
 */
...
public class AVLoadingIndicatorView extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        try {
            final TypedArray a = context.obtainStyledAttributes( attrs,
                    R.styleable.AVLoadingIndicatorView, defStyleAttr,
                    defStyleRes );
            mMinWidth = a.getDimensionPixelSize(
                    R.styleable.AVLoadingIndicatorView_minWidth, mMinWidth );
            mMaxWidth = a.getDimensionPixelSize(
                    R.styleable.AVLoadingIndicatorView_maxWidth, mMaxWidth );
            mMinHeight = a.getDimensionPixelSize(
                    R.styleable.AVLoadingIndicatorView_minHeight, mMinHeight );
            mMaxHeight = a.getDimensionPixelSize(
                    R.styleable.AVLoadingIndicatorView_maxHeight, mMaxHeight );
            String indicatorName = a
                    .getString( R.styleable.AVLoadingIndicatorView_indicatorName );
    ...
    public void setIndicator(Indicator d) {
        if (mIndicator != d) {
            ...
            mIndicator = d;
            // need to set indicator color again if you didn't specified when
     ...
     * setIndicatorColor(Color.parseColor("#FF4081")) or
     * setIndicatorColor(0xFF00FF00) or
