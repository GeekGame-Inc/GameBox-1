...
public class TimePickerDialog extends DialogFragment implements View.OnClickListener {
    ...
    OnTimePickerSeleteListener listener;
    ...
    private void initialize(PickerConfig pickerConfig) {
        ...
        mIController = new MyControllerImpl( pickerConfig );
    }
    ...
    public void setListener(OnTimePickerSeleteListener listener) {
    ...
    void sureClicked() {
        ...
        if (null != listener) {
            listener.onTimePickerSelete( mTimeWheel.getCurrentYear() + "",
                    mTimeWheel.getCurrentMonth() + "", mTimeWheel.getCurrentDay() + "" );
        }
        dismiss();
    }
