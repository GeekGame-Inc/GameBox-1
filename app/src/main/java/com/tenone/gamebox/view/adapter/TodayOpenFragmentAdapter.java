...
/**
 * ���տ������������������� ClassName:TodayOpenFragmentAdapter <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason: TODO ADD REASON. <br/>
 * Date: 2017-3-29 ����9:55:55 <br/>
 *
 * @author John Lie
 * @see
 * @since JDK 1.6
 */
public class TodayOpenFragmentAdapter extends BaseAdapter {

    private List<OpenServerMode> items;
    private Context mContext;
    private LayoutInflater mInflater;
    private OpenServiceWarnListener listener;
    private OpenItemClickListener openItemClickListener;

    public TodayOpenFragmentAdapter(List<OpenServerMode> list, Context cxt) {
        this.items = list;
        this.mContext = cxt;
